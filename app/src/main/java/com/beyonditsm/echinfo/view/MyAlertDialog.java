package com.beyonditsm.echinfo.view;
...
public class MyAlertDialog {
	...
	public String getEdit(){
		String edit=etRemark.getText().toString().trim();
		return edit;
	}

	public MyAlertDialog setMsg(String msg,boolean isCenter) {
		showMsg = true;
		if ("".equals(msg)) {
			txt_msg.setText("内容");
		} else {
	...
	public MyAlertDialog setRemark(String hint){
		etRemark.setVisibility(View.VISIBLE);
		if(hint!=null);
		etRemark.setHint(hint);
		return this;
	}
	
	public MyAlertDialog setPrompt(String prompt){
		txt_prompt.setVisibility(View.VISIBLE);
		if(prompt!=null){
			txt_prompt.setText(prompt);
		}
		return this;
	}
